    ...
    const option = {
        "uri": {
           ...
           "headers": {
            ...
            token: "Un2C9bDlUKXA5WBQkh3EXWsxq5pV1P09o00",
...
const getAssetDetailsApiByStackId = (stackId, callback) => {
    ...
    const option = {
        "uri": {
           ...
           "headers": {
            "accept": "application/json",
            token: "z2PVaa7nKf38G3bhZCo4bsC5qPiUfY9bkBII",
            assessmentcode: "ZDMzYThmOjc6MzMxOjE6MTowOjE="
           }
          }
    console.log("test endpoint")
...
module.exports.callApi = {callExternalApiUsingRequest, getAssetDetailsApiByStackId, getAssetDetailBySerach};